...
const Header = () => {
  ...
  // using searchparams to filter the url according to category
          ...
          <div className="dropdownmenu nav-item">
            ...
            >
              ...
              {categories.map(category =>(
                <><MenuItem onClick={handleClose} key={category.id}><Link to={`/?category=${category.type}`}>{category.type}</Link></MenuItem><Divider  /></>
              ))}
            </Menu>
          </div>
          {/* create blog */}
