...
//   fetching all post data from postid
  useEffect(() => {
  ...
  return (
    <Container sx={{ mt: 3 }}>
      ...
      {/* text area input */}
        ...
        <TextArea minRows={25} value={post.description} placeholder="Start your blog..." name="description" onChange={(e) => handleChange(e)}/>
      {/* publish button */}
      <div className="flex justify-center mb-2">
      <Button onClick ={()=> updateBlogPost()} variant="contained" sx={{backgroundColor:'#F2BE22',letterSpacing:'1px', ":hover":{backgroundColor:'#4FC0D0'}}}>Update</Button>
      </div>
